  ...
  const handleReport = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        AxiousPublic.post("/reported", {Product_name,productId : productId.toString()}).then((res) => {
          Swal.fire({
            title: "Reported!",
        ...
        <div className=" max-w-[1300px] mx-auto">
          <div className="flex xl:flex-row  flex-col md:p-0 gap-4 xl:justify-between justify-center xl:items-start items-center p-4">
            ...
            <div className="max-w-[630px]   group w-full flex-col flex xl:justify-start justify-center">
              ...
              <div className="mt-2">
                <h2 className="font-bold text-lg flex items-center gap-2">
                  <FaCalendar className="text-[#00ADB5]"></FaCalendar> Posted
              ...
              <div className=" flex items-center mt-4">
                <div className="flex items-center gap-6 mt-2 group">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      className={`border  p-3 rounded-full  border-[#00ADB5]/5 ${
                        access
                          ? "bg-gray-300"
                          : "cursor-pointer  bg-[#00ADB5]/5   text-[#00ADB5] transition-colors hover:border-[#00ADB5]/10 hover:bg-[#00ADB5]/10 hover:!opacity-100 group-hover:opacity-70"
                      }`}
                    >
                      <BiUpvote />
                    </span>
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      className={` rounded-full border border-[#00ADB5]/5   p-3 ${
                        access
                          ? " bg-gray-300 "
                          : "text-red-500 cursor-pointer transition-colors bg-[#00ADB5]/5 hover:border-[#00ADB5]/10 hover:bg-[#00ADB5]/10 hover:!opacity-100 group-hover:opacity-70"
                      } `}
                    >
                      <BiDownvote />
                    </span>
                ...
                <button
                  ...
                  className="flex items-center ml-8 btn border border-[#00ADB5]/5 bg-[#00ADB5]/5 p-3 text-red-500 transition-colors hover:border-[#00ADB5]/10 hover:bg-[#00ADB5]/10 hover:!opacity-100 group-hover:opacity-70"
                >
                  <span
                    data-tooltip-target="downvote-tooltip"
